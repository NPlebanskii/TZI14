...
//    tsg.setFileName("D:\\NazarsProjectsProgramming\\Qt_projects\\TZI_1\\englishText.txt");
//    QHash<QString, int> statistic = tsg.generateStatistic(1);
//    hwEnglish.setData(statistic);
//    hwEnglish.show();

//    HistogramWidget hwUkrainian;
//    tsg.setFileName("D:\\NazarsProjectsProgramming\\Qt_projects\\TZI_1\\ukrainianText.txt");
...
//    hwTest2.show();
    CezarDecoder cd("D:\\NazarsProjectsProgramming\\Qt_projects\\TZI_1\\SH_VT18");
